...
@Component({
  selector: 'app-tickets-productos',
  templateUrl: './tickets-productos.component.html',
  styleUrls: ['./tickets-productos.component.scss']
})
export class TicketsProductosComponent implements OnInit {
  listaTickets: Ticket[];
  ...
  obtenerTickets(){
    this.ticketService.getTicketCategoria(3).subscribe(data => {
