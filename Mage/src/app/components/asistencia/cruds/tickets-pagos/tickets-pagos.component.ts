...
@Component({
  selector: 'app-tickets-pagos',
  templateUrl: './tickets-pagos.component.html',
  styleUrls: ['./tickets-pagos.component.scss']
})
export class TicketsPagosComponent implements OnInit {
  listaTickets: Ticket[];
  ...
  obtenerTickets(){
    this.ticketService.getTicketCategoria(2).subscribe(data => {
